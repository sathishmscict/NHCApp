...
import com.nhcapp.databinding.ContentSearchBinding;
import com.nhcapp.databinding.RowItemBinding;
import com.nhcapp.helper.AllKeys;
import com.nhcapp.helper.CustomRequest;
import com.nhcapp.pojo.SearchData;
...
/*    public static final String TAG_SEARCH_ARRAY = "data";
   ...
   /* @Override
    ...
    private void getProductDataFromServer(final String str) {
        ...
        String url_getData = AllKeys.WEBSITE+"SearchProductData?text="+ str;
                    ...
                    if (error_status == false) {
                        ...
                        if (record_status == true) {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                ...
                                if(cc.getString(AllKeys.TAG_PARENTID).equals("0"))
                                {
                                ...
                                SearchData sc = new SearchData("true", "1", String.valueOf(cc.getInt(AllKeys.TAG_PRODUCT_ID)), cc.getString(AllKeys.TAG_PRODUCT_NAME), String.valueOf(cc.getInt(AllKeys.TAG_CATEGORYID)), cc.getString(AllKeys.TAG_CATEGORY_IMAGE), categortype, "","1", "1", "", String.valueOf(cc.getInt(AllKeys.TAG_OFFER_PRICE)),cc.getString(AllKeys.TAG_COMPANYID));
            ...
            rowItemBinding.stringName.setOnClickListener(new View.OnClickListener() {
              ...
              /*      Intent intent = new Intent(context , SingleItemActivity.class);
                    ...
                    try {
                        ...
                        if(list_SearchData.get(position).getSearch_category_type().equals("category"))
                        {
                        ...
                        {
                            sessionmanager.setSubCategoryTypeAndIdDetails(list_SearchData.get(position).getSearch_category_id(),"",list_SearchData.get(position).getSearch_category_type());
