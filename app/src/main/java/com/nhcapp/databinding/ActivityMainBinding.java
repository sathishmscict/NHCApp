package com.nhcapp.databinding;
...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    public final android.support.v7.widget.SearchView search;
    // variables
    // values
    // listeners
    ...
    public ActivityMainBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.listView = (android.widget.ListView) bindings[2];
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater,R.layout.content_search, root, attachToRoot, bindingComponent);
    }
    ...
    public static ActivityMainBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(R.layout.content_search, null, false), bindingComponent);
    }
