...
public class CategoryAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(userDetails.get(SessionManager.KEY_COMPANY_NAME));
        ...
        rv_category.addOnItemTouchListener(new dbhandler.RecyclerTouchListener(getApplicationContext(), rv_category, new dbhandler.ClickListener() {
            @Override
...
*/
                ...
                if (list_cateogry.get(position).getTotalsubcategories().equals("0")) {


                    if (list_cateogry.get(position).getTotalproducts().equals("0")) {
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(CategoryAcitivity.this);

                        alertDialogBuilder.setTitle("Products Information");
                        alertDialogBuilder.setMessage("Sorry, no products are avalable in " + list_cateogry.get(position).getCategoryname());
                    ...
                    intent.putExtra(AllKeys.CATEGORYID, list_cateogry.get(position).getCategoryid());
